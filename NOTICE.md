...
| FFmpeg, LAME, Opus, dav1d, and libwebp CLI build | `third_party/ffmpeg/` (license texts and `NOTICE.md`), `tools/ffmpeg/sources.lock`, build recipes, and committed `jniLibs` executables | FFmpeg 7.1.5 LGPL-2.1-or-later; LAME 3.100 LGPL-2.0-or-later (GNU Library GPL v2); Opus 1.5.2 BSD-3-Clause; dav1d 1.5.0 BSD-2-Clause; libwebp 1.4.0 BSD-3-Clause |
...
in that APK. Pinned upstream sources for FFmpeg, LAME, Opus, dav1d, libwebp, MeCab, fugashi, and
