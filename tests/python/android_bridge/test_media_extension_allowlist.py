...
def test_kotlin_audio_allowlist_covers_every_audio_producer() -> None:
    covered = _kotlin_extensions("AUDIO_EXTENSIONS") | _kotlin_extensions("DEVICE_CONDITIONAL_EXTENSIONS")
...
def test_kotlin_image_allowlist_matches_the_dictionary_media_whitelist() -> None:
    ...
    # deliberate DEVICE_CONDITIONAL_EXTENSIONS entry carrying its measured per-API values.
    covered = _kotlin_extensions("IMAGE_EXTENSIONS") | _kotlin_extensions("DEVICE_CONDITIONAL_EXTENSIONS")
    assert covered == _producer_image_extensions()


def test_device_conditional_extensions_never_evict_a_downloaded_audio_format() -> None:
    ...
    excluded = _kotlin_extensions("DEVICE_CONDITIONAL_EXTENSIONS")
