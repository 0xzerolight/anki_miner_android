...
class ProviderQueryContractTest {
    ...
    fun `production provider package exposes only sealed pinned mutations`() {
        ...
        assertEquals(2, Regex("resolver\\.update\\s*\\(").findAll(source).count())
        ...
        assertTrue(source.contains("AnkiProviderMutationCommand.CreateAnkiMinerModel"))
        assertTrue(source.contains("AnkiProviderMutationCommand.UpdateAnkiMinerTemplate"))
