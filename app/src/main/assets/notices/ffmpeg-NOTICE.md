# FFmpeg, LAME, Opus, dav1d, and libwebp notice
...
LAME, Opus, dav1d, or libwebp code is linked into the application process. Each
executable statically includes the FFmpeg libraries, LAME, Opus, dav1d, and
libwebp, and retains only Android system-library dependencies.
...
`CONFIG_GPLV3=0`, and `CONFIG_NONFREE=0`. All five licenses are compatible with
