...
- Settings can be searched. Typing part of a setting's name — or of the explanation under it — lists the settings that match, in either language, and picking one opens the tab it lives on and scrolls to it. Adding words narrows the list rather than widening it, and a setting whose name you typed is ranked above one that merely mentions your words.
