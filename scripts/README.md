...
emitted by `am instrument -w -r`. That script pins `expected_executed_test_count=165`
(182 discovered, minus 17 explicitly reported UNEXECUTED tests: external-UniDic,
